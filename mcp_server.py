...
The server is public by design. Set MCP_ENABLED=0 to disable the endpoint, or
MCP_ALLOWED_TOOLS to a comma-separated allow-list when a deployment should be
read-only. Never add provider secrets or raw filesystem access to this module.
"""
